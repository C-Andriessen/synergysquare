        ...
        <nav class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" aria-label="Top">
            <div class="flex w-full items-center justify-between border-b border-indigo-500 py-6 lg:border-none">
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="text-white text-3xl">
                        SynergySquare
                    </a>
                ...
                <div class="ml-10 space-x-4">
                    <a href="#" class="inline-block rounded-md border border-transparent bg-rose-800 py-2 px-4 text-base font-medium text-white hover:bg-opacity-75">Sign in</a>
                    <a href="#" class="inline-block rounded-md border border-transparent bg-white py-2 px-4 text-base font-medium text-rose-500 hover:bg-indigo-50">Sign up</a>
                </div>
            </div>
                    ...
                    <div>
                        <div class="mt-20">
                            ...
                            <div class="mt-6 sm:max-w-xl">
                                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">The easiest platform to invest.</h1>
                                <p class="mt-6 text-xl text-gray-500">Come and invest on our platform without making it rocket science for you!</p>
                            </div>
                            <div class="mt-6">
                                <div class="inline-flex items-center divide-x divide-gray-300">
                                    ...
                                    <div class="min-w-0 flex-1 py-1 pl-5 text-sm text-gray-500 sm:py-3"><span class="font-medium text-gray-900">Rated 5 stars</span> by over <span class="font-medium text-rose-500">500 users</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
                    <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                        ...
                        <div class="relative -mr-40 pl-4 sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12">
                            <img class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none" src="/images/dashboard.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
                    <div class="relative sm:py-16 lg:py-0">
                        ...
                        <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
                            ...
                            <div class="relative overflow-hidden rounded-2xl pt-64 pb-10 shadow-xl">
                                <img class="absolute inset-0 h-full w-full object-cover" src="/images/lars.jpeg" alt="">
                                ...
                                <div class="relative px-8">
                                    <blockquote class="mt-8">
                                        ...
                                        <footer class="mt-4">
                                            <p class="text-base font-semibold text-rose-200">Lars van Maanen, CEO at SynergySquare</p>
                                        </footer>
                                    </blockquote>
                                </div>
                            </div>
                    ...
                    <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
                        ...
                        <div class="pt-12 sm:pt-16 lg:pt-20">
                            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Investment is the key</h2>
                        ...
                        <div class="mt-10">
                            <dl class="grid grid-cols-2 gap-x-4 gap-y-8">
                                <div class="border-t-2 border-gray-100 pt-6">
                                    ...
                                    <dd class="text-3xl font-bold tracking-tight text-gray-900">2022</dd>
                                </div>
                                ...
                                <div class="border-t-2 border-gray-100 pt-6">
                                    <dt class="text-base font-medium text-gray-500">Users</dt>
                                    <dd class="text-3xl font-bold tracking-tight text-gray-900">521</dd>
                                </div>

                                <div class="border-t-2 border-gray-100 pt-6">
                                    <dt class="text-base font-medium text-gray-500">Raised</dt>
                                    <dd class="text-3xl font-bold tracking-tight text-gray-900">$100M+</dd>
                                </div>
                            </dl>
                            <div class="mt-10">
                                <a href="#" class="text-base font-medium text-rose-500">Learn more about how we're investing in startups&nbsp&rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-32">
                <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                    <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-24">
                        <div>
                            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our partners and biggest investors</h2>
