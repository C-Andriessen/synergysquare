            ...
            <main>
                            ...
                            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                                <div class="lg:py-24">
                                    <h1 class="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                        ...
                                        <span class="block bg-gradient-to-r from-teal-200 to-cyan-400 bg-clip-text pb-3 text-transparent sm:pb-5">show your startup</span>
                                    </h1>
                ...
                <div class="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
                    <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                        <div>
                            <h2 class="text-lg font-semibold text-cyan-600">Easy</h2>
                            <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">No money for startup? No problem.</p>
                ...
                <div class="relative bg-white py-16 sm:py-24 lg:py-32">
                    <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                        <h2 class="text-lg font-semibold text-cyan-600">Get faster results</h2>
                        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Everything you need to start your company</p>
                        <p class="mx-auto mt-5 max-w-prose text-xl text-gray-500">Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla.</p>
                        <div class="mt-12">
                        ...
                        <div class="relative lg:-my-8">
                            ...
                            <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:h-full lg:p-0">
                                <div class="aspect-w-10 aspect-h-6 overflow-hidden rounded-xl shadow-xl sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none lg:h-full">
                                    <img class="object-cover lg:h-full lg:w-full" src="/images/lars.jpeg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="mt-12 lg:col-span-2 lg:m-0 lg:pl-8">
                            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
                                <blockquote>
                                    ...
                                    <footer class="mt-6">
                                        <p class="text-base font-medium text-white">Lars van Maanen</p>
                                        <p class="text-base font-medium text-cyan-100">CEO at SynergySquare</p>
                                    </footer>
                                </blockquote>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
                                ...
                                <div class="flex flex-1 flex-col justify-between bg-white p-6">
                                    <div class="flex-1">
                                        ...
                                        <a href="#" class="mt-2 block">
                                            <p class="text-xl font-semibold text-gray-900">How to get your first investors</p>
                            ...
                            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
                                ...
                                <div class="flex flex-1 flex-col justify-between bg-white p-6">
                                    <div class="flex-1">
                                        ...
                                        <a href="#" class="mt-2 block">
                                            <p class="text-xl font-semibold text-gray-900">Improve your startup page</p>
                ...
                <div class="relative bg-gray-900">
                    ...
                    <div class="relative mx-auto max-w-md px-4 py-12 sm:max-w-7xl sm:px-6 sm:py-20 md:py-28 lg:px-8 lg:py-32">
                        <div class="md:ml-auto md:w-1/2 md:pl-10">
                            <h2 class="text-lg font-semibold text-gray-300">SynergySquare support</h2>
